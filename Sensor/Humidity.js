$(function() {
    ...
    $(document).ready(function() {
        ...
        chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Sensor\'s Dynamic Humidity'
            },
            subtitle: {
        ...
        setInterval(function() {
            ...
            $.ajax({
            url:"//192.168.199.187/statistic/Humidity/history",
            ...
            success:function(data)
            {
                ...
                //alert(realtime[0]);
                //alert(realvalue[0]);
                //chart.series[0].addPoint([realtime[0],realvalue[0]]);
                //chart.series[1].addPoint([realtime[0],realvalue[0]]);
        },
